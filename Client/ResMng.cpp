...
ResMng::ResMng()
{
  ...
  SetEnt(block, RES_SPRITE_WALL, BRICK);
  SetEnt(block, RES_SPRITE_CRATE, LIGHT_BROWN);
  SetEnt(block, RES_SPRITE_BOMB, GREY);
  ...
  SetEnt(burn_1, RES_SPRITE_BURN_1, WHITE);
  SetEnt(burn_2, RES_SPRITE_BURN_2, WHITE);
}
